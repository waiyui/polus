...
Route::get('/chat', 'App\Http\Controllers\MessageController@index')->name('chat');
Route::get('/message/{id}', 'App\Http\Controllers\MessageController@getMessage')->name('message');
Route::post('/message', 'App\Http\Controllers\MessageController@sendMessage');
